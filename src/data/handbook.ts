...
export const PARTS: ViolinPart[] = [
  ...
  },
  {
    id: "shoulderrest",
    name: "肩墊",
    nameEn: "Shoulder Rest",
    group: "持琴",
    summary: "讓肩膀接住琴，左手才不必抓緊。",
    detail:
      "肩墊是二十世紀才普及的配件：兩隻腳夾住下圓的邊緣，弧形橫桿與軟墊貼在鎖骨上。有了它，琴的重量與方向就交給肩膀與下巴，左手可以完全自由地移動。它同時是可以拆下來的——演奏前裝上，收琴時取下，才不會長期壓住下圓的漆面與側板。",
  },
  {
    id: "bow",
    name: "琴弓",
